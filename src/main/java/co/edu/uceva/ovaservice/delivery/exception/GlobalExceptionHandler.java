...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handlePaginaSinOvas(PaginaSinOvasException ex) {
    ...
    public ResponseEntity<Map<String, Object>> handleNoHayOvas(NoHayOvasException ex) {
        Map<String, Object> response = new HashMap<>();
        response.put(MENSAJE, "No hay productos en la base de datos.");
        response.put(OVAS, null); // para que sea siempre el mismo campo
    ...
    public ResponseEntity<Map<String, Object>> handleOvaNoEncontrado(OvaNoEncontradoException ex) {
        Map<String, Object> response = new HashMap<>();
    ...
    public ResponseEntity<Map<String, Object>> handleOvaExistente(OvaExistenteException ex) {
        Map<String, Object> response = new HashMap<>();
        response.put(ERROR, ex.getMessage());
